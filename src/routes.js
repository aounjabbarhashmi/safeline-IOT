...
const routes = [
  ...
  { path: '/organizations', name: 'Organization', element: Organization },
  ...
  { path: '/user-management', name: 'UserManagement', element: UserManagement },
  { path: '/organization-sensors', name: 'OrganizationSensors', element: OrganizationSensors },
  { path: '/devices-sensors', name: 'DevicesSensors', element: DevicesSensors },
]
